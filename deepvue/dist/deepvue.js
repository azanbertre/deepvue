...
var script$3 = vue.defineComponent({
    ...
    setup: function (props, ctx) {
        ...
        var loadingElement = vue.h('div', {
            class: [
                'd-button__loading'
            ]
        });
        var element = vue.h('button', __assign(__assign({}, attrs), { style: mergeDicts((_a = {},
...
var script$1 = vue.defineComponent({
    ...
    setup: function (props, ctx) {
        ...
        var attrs = ctx.attrs;
        var hasDefaultSlot = !!slots['default'];
        var element = vue.h('div', __assign(__assign({}, attrs), { class: mergeClass([
                'd-col',
...
var script = vue.defineComponent({
    ...
    setup: function (props, ctx) {
        ...
        var attrs = ctx.attrs;
        var hasDefaultSlot = !!slots['default'];
        var element = vue.h('div', __assign(__assign({}, attrs), { class: mergeClass(['d-row'], attrs.class), style: mergeDicts({
                justifyContent: props.justify,
                alignItems: props.align,
